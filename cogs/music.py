from cogs.voice_utilities import *
...
ids = ["408077627908161556","275312272975462411","459105052653781015","84494950670012416","393562571388616715","397319905835483136","330265678105804801","458764171803099136","207952150918201344"]
...
class Music:
    ...
    #     try:
    #         entry_list, position = await player.playlist.import_from(song)
    ...
    async def argplay(self, ctx, song: str, channel : str = None):
        ...
        author_channel = ctx.message.author.voice.voice_channel
        my_channel = serverdos.me.voice.voice_channel
